...
- Side key: choose what holding it does: the assistant picker, a standard Google web search, or talking straight to Google, Claude or Perplexity (Side Key page).
